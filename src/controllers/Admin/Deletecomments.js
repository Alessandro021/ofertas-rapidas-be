...
export const validateReqDeleteCommentsParams = validateData("params", validateParams);

export const validateReqDeleteCommentsBody = validateData("body", validateBody);
